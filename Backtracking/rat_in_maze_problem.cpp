...
void mazehelper(int maze[][20], int n, int** solution, int x, int y){
    ...
    solution[x][y] = 1;//my present location is 1.
    mazehelper(maze, n, solution, x-1, y);//for up.
    mazehelper(maze, n, solution, x+1, y);//for down
    mazehelper(maze, n, solution, x, y-1);//for left
    mazehelper(maze, n, solution, x, y+1);//for right
    solution[x][y] = 0; //all explored loctions will be zero.
